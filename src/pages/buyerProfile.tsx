...
export default function BuyerProfile() {
  ...
  const fetchUserData = () => {
    axios
      .get(`http://localhost:8001/buyer/${buyerId}`)
      .then((response) => {
  ...
  const fetchAddressData = () => {
    axios
      .get(`http://localhost:8001/buyer/address/${buyerId}`)
      .then((response) => {
  ...
  const handleSaveContactNumber = () => {
    ...
    axios
      .put(`http://localhost:8001/buyer/contact/${buyerId}`, {
  ...
  const handleSaveEmail = () => {
    ...
    axios
      .put(`http://localhost:8001/buyer/email/${buyerId}`, { email: newEmail })
      .then((response) => {
  ...
  const handleSavePassword = () => {
    ...
    axios
      .put(`http://localhost:8001/buyer/password/${buyerId}`, {
        currentPassword,
        newPassword,
      })
      .then((response) => {
  ...
  const handleSaveAddress = () => {
    axios
      .put(`http://localhost:8001/buyer/address/${buyerId}`, {
  ...
  const handleSaveProfilePicture = async () => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:8001/buyer/profile/photo/${buyerId}`,
        formData,
        {
          headers: {
  ...
  const handleSaveCity = () => {
    axios
      .put(`http://localhost:8001/buyer/city/${buyerId}`, { city: newCity })
      .then((response) => {
              ...
              <Row>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center" }}>
                    ...
                    />{" "}
                    {/* Credit card icon */}
                    <div>Add Payment Method</div> {/* Text */}
                  </div>
                </Card>
              </Row>
            </Col>
