            ...
            <div className="farmer-ellipse d-flex align-items-center justify-content-md-end justify-content-center">
              ...
              >
                ...
                <img
                  ...
                  src={Ellipse2}
                  alt="Ellipse2"
                  style={{ width: "30px", height: "auto", marginLeft: "42px" }}
                />
                <img
                  className="ellipse3"
                  src={Ellipse3}
      ...
      >
        <div className="text-topic5">
          ...
          >
            ...
            business with us, but don't just believe us when we say so. Hear to
            it for them.
          </p>
        </div>
      </div>
        ...
        <div className="row justify-content-center align-items-center">
          <div className="col-md-6 text-center">
            ...
            >
              ...
              far. When we have problems, the teams support us and offer advice
              as a service. AgriMarket is a great option if you want to improve
