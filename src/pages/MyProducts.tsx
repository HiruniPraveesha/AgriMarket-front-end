...
const MyProducts: React.FC<{}> = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/products/seller/${myBuyer}`)
      .then((response) => {
  ...
  const fetchReviewCount = (productId: number) => {
    axios
      .get(`http://localhost:8080/reviews/count/${productId}`)
      .then((response) => {
    ...
    <SellerLayout>
      <Container>
        <Container>
          ...
          <Row className="justify-content-center">
            <Col md={3}>
              <Link to="/sellerNotification" style={{ textDecoration: "none" }}>
                <Button
                  variant="success"
                  className="mb-3 w-100 d-flex align-items-center justify-content-center"
                  style={{
                ...
                >
                  ...
                  >
                    ...
                    <Rate
                      ...
                      disabled
                    />
                    <p style={{ fontSize: "12px", color: "#767577" }}>
                      {reviewCount} ratings and reviews
                    </p>
                  </Col>
                  <Col
                    xs={8}
