      ...
      <Row>
          ...
          <div className="p-3">
            ...
            <div className="mb-5">
              <a
                ...
                style={{
                  color: selectedMenuItem === "Dashboard" ? "blue" : "black",
                  fontWeight:
                    selectedMenuItem === "Dashboard" ? "bold" : "normal",
                }}
        ...
        <Col className="col-md-10" style={mainContentStyle}>
            ...
            <Col className="col-md-3">
              <Card style={{ backgroundColor: "#FFCCCC" }}>
                ...
                >
                  ...
                  <Card.Link href="#" style={{ marginLeft: "145px" }}>
                    More
                  </Card.Link>
                </Card.Body>
              </Card>
          ...
          <Row>
            <Col md={10}>
              <Card
                style={{ width: "450px", height: "460px", marginLeft: "300px" }}
              >
                <br></br>
                <Card.Title style={{ fontSize: "20px", marginLeft: "10px" }}>
                  Total Sales
                </Card.Title>
