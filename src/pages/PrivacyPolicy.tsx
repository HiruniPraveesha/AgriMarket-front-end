...
const PrivacyPolicyPage = () => {
  return (
    <div>
      <MainHeader />
      <div className="container mt-3 ms-10 me-8">
        <h1 style={{ fontSize: "1.5rem", color: "#444", marginBottom: "1rem" }}>
          Privacy Policy
        </h1>
        ...
        <p style={{ fontSize: "0.9rem", color: "#666", marginBottom: "1rem" }}>
          ...
          contact us at{" "}
          <a href="mailto:privacy@agrimarket.com" style={{ color: "#007bff" }}>
            privacy@agrimarket.com
          </a>
          .
        </p>
      </div>
