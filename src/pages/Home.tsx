...
const Home: React.FC = () => {
  ...
  return (
    <div>
      <Header />
      <Container fluid className="p-0 bg-light" ref={firstContainerRef} style={{ margin: 0, padding: 0, backgroundColor: '#DFFFC0', overflow: 'hidden' }}>
        <Row className="m-0">
          ...
          <Col md={5} className="p-0 d-md-flex align-items-center" style={{ backgroundColor: '#DFFFC0' }}>
            <div className="text-center text-md-start p-3">
              ...
              <p className="text-success fw-bold" style={{
                color: '#00BA29',
                fontSize: '28px',
                fontWeight: 'bold',
                letterSpacing: '1px',
              ...
              <div className="mt-4">
                <Button variant="primary" className="me-2" style={{
            ...
            <Col key={product.product_id} md={4} className="d-flex justify-content-center mb-4">
              ...
              <Card.Img variant="top" 
                ...
                <Card.Body className="text-center">
                  <Card.Title style={{ fontSize: '15px' }}>{product.name}</Card.Title>
                  <Card.Text>Rs.{product.price}</Card.Text>
                  <Card.Text style={{ fontSize: '15px', fontFamily: 'Sans-serif', fontStyle:'italic', cursor: 'pointer' }}
                   onClick={(e) => {
                    e.preventDefault();
                    navigate(`/SellerProfile/${product.seller.seller_id}`);
                    }}
