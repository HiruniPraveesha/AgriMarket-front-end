        ...
        <Row style={{ paddingLeft: "100px" }}>
          ...
          <Col className="col-md-10" style={mainContentStyle}>
            <Row className="p-3">
              ...
              <Col className="col-md-3">
                <Card style={{ backgroundColor: "#19B01C", color: "white" }}>
                  <Card.Body>
                    <Card.Title style={{ fontSize: "16px" }}>Products</Card.Title>
                    <Card.Text style={{ fontSize: "25px" }}>{productCount}</Card.Text>
                  </Card.Body>
                </Card>
              </Col>
              <Col className="col-md-3">
            ...
            <Row>
              ...
              <Col md={2}></Col>
              <Col md={5}>
                <Card style={{ width: "400px", height: "360px", marginLeft: "10px", backgroundColor: "rgba(136,255,95, 0.3)"}}>
                  <Card.Body>
            ...
            <br></br>
            <Row>
              <Card className="p-3" style={{ backgroundColor: "rgba(136,255,95, 0.3)" }}>
                <Card.Title>
                  <div className="row">
                ...
                <Card.Body style={scrollingListStyle}>
                  {ordersData.map((order) => (
                    <Card
                      ...
                      style={{
                        marginBottom: "10px",
                        backgroundColor: "linear-gradient(to bottom, rgba(255, 255, 255, 0.5), rgba(204, 255, 204, 0.5))",
                      }}
                    >
                      <Card.Body
                        style={{
