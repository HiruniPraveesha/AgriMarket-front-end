...
export default function SellerProfile() {
  ...
  const getSellerDetails = async () => {
    try {
      const response = await axios.get(`http://localhost:8080/get-seller-details`, {
        params: { id }
      });
  ...
  const handleSaveContactNumber = async () => {
    try {
      const response = await axios.put('http://localhost:8080/change-contact-number', {
        id,
        newContactNumber,
      });
                ...
                <Col>
                  <Form style={{ fontSize: "11px" }}>
                    ...
                    <Form.Group>
                      ...
                      <p style={{ color: "#666666", marginBottom: "1px" }} />
                      <Form.Group>
                        <p style={{ color: "#666666", marginBottom: "15px", marginTop:'-5px' }}>
                          <span>{userName}</span>
                        </p>
                      </Form.Group>
