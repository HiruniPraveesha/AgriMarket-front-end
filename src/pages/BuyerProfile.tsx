...
const fetchUserData = () => {
  // Example: Fetch user profile data from backend
  axios.get('http://localhost:8001/api/buyer/details/1')
      .then(response => {
          const { contactNumber, email, profilePicture} = response.data;
                          ...
                          <Row>
                              <Col>
                                  <Form style={{ fontSize: '11px' }}>
                                      ...
                                      <Modal show={showContactNumberModal} onHide={() => setShowContactNumberModal(false)} style={{ fontSize: '12px' }}>
                                          ...
                                          <Modal.Body>
                                              <Form.Group>
                                                  ...
                                                  <Form.Control type="text" value={newcontactNumber} onChange={(e) => setNewContactNumber(e.target.value)} style={{ fontSize: '12px' }} />
                                              </Form.Group>
                                          </Modal.Body>
                                          <Modal.Footer>
                                      ...
                                      <Form.Group>
                                          <p style={{ marginBottom: '5px', fontWeight: 'bold' }}>Edit Email Address</p>
                                          <p style={{ color: '#666666', marginBottom: '1px' }} />
                                          <Form.Group>
                                              <p style={{ color: '#666666', marginBottom: '1px' }}>
                                                  <span>{email}</span>
                                              </p>
                                              <Button variant="link" style={{ padding: '0', color: '#00BA29', fontSize: '11px', marginBottom: '15px' }} onClick={handleEditEmail}>Edit</Button>
                                          </Form.Group>
                                          <Modal show={showUserNameModal} onHide={() => setShowUserNameModal(false)} style={{ fontSize: '12px' }}>
                                              <Modal.Header closeButton>
                                                  <Modal.Title style={{ fontSize: '12px' }}>Edit Email Address</Modal.Title>
                                              </Modal.Header>
                                              <Modal.Body>
                                                  <Form.Group>
                                                      <Form.Label>New Email Address</Form.Label>
                                                      <Form.Control type="text" value={newEmail} onChange={(e) => setNewEmail(e.target.value)} style={{ fontSize: '12px' }} />
                                                  </Form.Group>
                                              </Modal.Body>
                                              <Modal.Footer>
