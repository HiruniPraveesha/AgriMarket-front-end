...
const ItemDetails: React.FC<{}> = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8080/reviews/${productId}/ratingTotals`)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://localhost:8080/products/more/${productId}?limit=${cardCount}`
      )
      .then((response) => {
      ...
      <Container style={{ marginTop: "20px" }}>
          ...
          >
                ...
                {images.map((image, index) => (
                  <Card.Img
                    ...
                    style={{
                      cursor: "pointer",
                      border:
                        mainImage === image ? "2px solid #00BA29" : "1px solid",
                      height: "75px",
                      width: "75px",
                      margin: "5px",
                    }}
            ...
            <Col xs={12} md={4} style={{ padding: "10px", order: 1 }}>
              <Card.Body style={{ paddingBottom: "25px" }}>
                ...
                <Card.Text>
                  Rs.{product.price}{" "}
                  {[1, 2, 3].includes(product.categoryId) ? "per kg" : ""}
                </Card.Text>
                <Card.Text
                  style={{
                    fontFamily: "Sans-serif",
        ...
        <Row className="justify-content-center" style={{ marginTop: "10px" }}>
          ...
          >
            <div
              className="mt-4 ml-4"
              style={{ paddingLeft: "0", backgroundColor: "#F5F5F5" }}
            >
              <h3
                style={{
                  fontSize: "16px",
              ...
              >
                ...
                >
                  <p style={{ fontSize: "22px" }}>
                    {calculateHighRatingPercentage().toFixed(1)}
                    <span>
                      {" "}
                      <p
                        style={{
                  ...
                  <Rate
                    allowHalf
                    value={calculateHighRatingPercentage()}
                    disabled
                  />
                  <div>
                    <p
                    ...
                    >
                      {ratingTotals.rating1 +
                        ratingTotals.rating2 +
                        ratingTotals.rating3 +
                        ratingTotals.rating4 +
                        ratingTotals.rating5}
                    </p>
                  </div>
                </Col>
                  ...
                  <div style={{ padding: "10px" }}>
                    <div style={{ display: "flex", alignItems: "center" }}>
                      ...
                      <div style={{ flex: 1, marginLeft: "10px" }}>
                        {getProgressBar(
                          (ratingTotals.rating5 / reviewCount) * 100
                        )}
                      </div>
                    ...
                    >
                      ...
                      <div style={{ flex: 1, marginLeft: "10px" }}>
                        {getProgressBar(
                          (ratingTotals.rating4 / reviewCount) * 100
                        )}
                      </div>
                      <span style={{ marginLeft: "15px" }}>
                        {ratingTotals.rating4}
                    ...
                    >
                      ...
                      <div style={{ flex: 1, marginLeft: "10px" }}>
                        {getProgressBar(
                          (ratingTotals.rating3 / reviewCount) * 100
                        )}
                      </div>
                      <span style={{ marginLeft: "15px" }}>
                        {ratingTotals.rating3}
                    ...
                    >
                      ...
                      <div style={{ flex: 1, marginLeft: "10px" }}>
                        {getProgressBar(
                          (ratingTotals.rating2 / reviewCount) * 100
                        )}
                      </div>
                      <span style={{ marginLeft: "15px" }}>
                        {ratingTotals.rating2}
                    ...
                    >
                      ...
                      <div style={{ flex: 1, marginLeft: "10px" }}>
                        {getProgressBar(
                          (ratingTotals.rating1 / reviewCount) * 100
                        )}
                      </div>
                      <span style={{ marginLeft: "15px" }}>
                        {ratingTotals.rating1}
