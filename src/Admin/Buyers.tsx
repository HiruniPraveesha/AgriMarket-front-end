...
import { Container, Row, Col, FormControl, DropdownButton, Dropdown } from 'react-bootstrap';
...
const BuyerRow: React.FC<BuyerRowProps> = ({ buyer_id, email, contactNo, name, address, onDelete }) => {
...
const Buyers: React.FC = () => {
  ...
  useEffect(() => {
    const fetchBuyers = async () => {
      try {
        const response = await axios.get('http://localhost:8080/admin/getAllBuyers');
        ...
        <Row>
          <Col md="10">
            <Row className="mb-4 d-flex justify-content-between align-items-center" style={{ fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase', color: 'gray' }}>
              <Col md="1" lg="1" xl="1"><h6 style={{ fontSize: '10px' }}>Buyer ID</h6></Col>
              <Col md="1" lg="1" xl="1"></Col>
              <Col md="5" lg="5" xl="5"><h6 style={{ fontSize: '10px' }}>Email</h6></Col>
              <Col md="3" lg="3" xl="3" className="d-flex align-items-center"><h6 style={{ fontSize: '10px' }}>Contact Info</h6></Col>
              <Col md="1" lg="1" xl="1"></Col>
            </Row>
